!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(((t = t || self).ReactRouter = {}), t.React);
})(this, function (t, c) {
  "use strict";
          ...
          ? "/" !== o.pathname.charAt(0) &&
            (o.pathname = (function (t, e) {
              var n = 1 < arguments.length && void 0 !== e ? e : "",
                ...
                c = i || a;
              if (
                (t && m(t) ? (o = r) : r.length && (o.pop(), (o = o.concat(r))),
                !o.length)
              )
                return "/";
              var u = void 0;
              ...
              if (!c) for (; p--; ) o.unshift("..");
              !c || "" === o[0] || (o[0] && m(o[0])) || o.unshift("");
              var h = o.join("/");
  ...
  function w(t, e) {
    return (
      ...
      (function n(e, r) {
        ...
        var t = void 0 === e ? "undefined" : g(e);
        if (t !== (void 0 === r ? "undefined" : g(r))) return !1;
  ...
  function O(t) {
    ...
    var f = E(a, 0, r.length - 1),
      h = r.map(function (t) {
        return C(t, void 0, "string" == typeof t ? l() : t.key || l());
      }),
      d = P;
    function m(t) {
      var e = E(y.index + t, 0, y.entries.length - 1),
        n = y.entries[e];
    ...
    var y = {
      ...
      replace: function (t, e) {
        var n = "REPLACE",
          r = C(t, e, l(), y.location);
        s.confirmTransitionTo(r, n, o, function (t) {
          t && ((y.entries[y.index] = r), p({ action: n, location: r }));
        });
      },
      go: m,
      goBack: function () {
    ...
    $ = (function (o) {
      function t() {
        for (var t, e = arguments.length, n = new Array(e), r = 0; r < e; r++)
          n[r] = arguments[r];
        return (
          ((t = o.call.apply(o, [this].concat(n)) || this).history = O(
            t.props
          )),
          t
        );
  ...
  function W(p) {
    for (var l = new Array(p.length), t = 0; t < p.length; t++)
      "object" == typeof p[t] &&
        (l[t] = new RegExp("^(?:" + p[t].pattern + ")$"));
    return function (t, e) {
      for (
        var n = "",
          r = t || {},
  ...
  function rt(s, t) {
    ...
    return [].concat(n).reduce(function (t, e) {
      ...
      var n = (function (t, e) {
          ...
          return nt < et && ((r[t] = i), nt++), i;
        })(e, { end: p, strict: l, sensitive: f }),
        r = n.regexp,
        o = n.keys,
        i = r.exec(s);
      if (!i) return null;
  ...
  var ot = (function (t) {
    ...
    return (
      ...
      (e.prototype.render = function () {
        var c = this;
        return s.createElement(T.Consumer, null, function (t) {
          t || x(!1);
  ...
  var pt = (function (o) {
        ...
        (e.navigateTo = function (t, e) {
          ...
          (a.action = e),
            (a.location = (function (t, e) {
              return t ? v({}, e, { pathname: at(t) + e.pathname }) : e;
            })(o, C(t))),
            (a.url = ct(a.location));
        }),
        (e.render = function () {
          var t = this.props,
            ...
            i = t.location,
            a = void 0 === i ? "/" : i,
            c = it(t, ["basename", "context", "location"]),
            u = {
              ...
              location: (function (t, e) {
                ...
                return 0 !== e.pathname.indexOf(n)
                  ? e
                  : v({}, e, { pathname: e.pathname.substr(n.length) });
              })(n, C(a)),
          ...
          return s.createElement(A, v({}, c, { history: u, staticContext: o }));
        }),
        t
      );
    })(s.Component),
    lt = (function (t) {
      ...
      return (
        ...
        (e.prototype.render = function () {
          var t = this;
          return s.createElement(T.Consumer, null, function (n) {
            n || x(!1);
            var r,
              o,
              i = t.props.location || n.location;
            return (
              s.Children.forEach(t.props.children, function (t) {
                if (null == o && s.isValidElement(t)) {
                  var e = (r = t).props.path || t.props.from;
                  o = e ? rt(i.pathname, v({}, t.props, { path: e })) : n.match;
                }
              }),
              o ? s.cloneElement(r, { location: i, computedMatch: o }) : null
            );
          });
        }),
        e
    ...
    mt = {};
  function yt(t) {
    return a.isMemo(t) ? dt : mt[t.$$typeof] || ft;
  }
  mt[a.ForwardRef] = {
    $$typeof: !0,
    render: !0,
  ...
  var wt = function t(e, n, r) {
    ...
    var i = gt(n);
    bt && (i = i.concat(bt(n)));
    for (var a = yt(e), c = yt(n), u = 0; u < i.length; ++u) {
      var s = i[u];
      if (!(ht[s] || (r && r[s]) || (c && c[s]) || (a && a[s]))) {
        var p = xt(n, s);
        try {
          vt(e, s, p);
        } catch (t) {}
  ...
  (t.MemoryRouter = $),
    (t.Prompt = function (t) {
      var r = t.message,
        ...
        o = void 0 === e || e;
      return s.createElement(T.Consumer, null, function (t) {
        if ((t || x(!1), !o || t.staticContext)) return null;
        ...
        var e = t.history,
          ...
          o = C(
            i
              ? "string" == typeof a
                ? Z(a, i.params)
                : v({}, a, { pathname: Z(a.pathname, i.params) })
              : a
          );
        return n
          ? (r(o), null)
    ...
    (t.useRouteMatch = function (t) {
      var e = Ot(),
        n = Et(T).match;
      return t ? rt(e.pathname, t) : n;
    }),
    (t.withRouter = function (r) {
      function t(t) {
        var e = t.wrappedComponentRef,
          n = it(t, ["wrappedComponentRef"]);
        return s.createElement(T.Consumer, null, function (t) {
          return t || x(!1), s.createElement(r, v({}, n, t, { ref: e }));
        });
      }
